...
parser.add_argument('--nepoch', type=int, default=120, help='number of epochs to train for') # 200
...
parser.add_argument('--a2', type=float, default=0.01)
parser.add_argument('--recons_weight', type=float, default=0.1, help='recons_weight for decoder')
...
parser.add_argument('--freeze_dec', action='store_true', default=True, help='Freeze Decoder for fake samples')
...
parser.add_argument('--cross_weight', type=float, default=0.02)
