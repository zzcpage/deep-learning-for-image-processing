...
input_shape = (96, 96, 3)
img= os.listdir('E:\WBB\luansheng\Dataset\Train2')
...
images = []
img_labels = []
for guy in os.listdir('E:\WBB\luansheng\Dataset\Train2'):
    person_dir = os.path.join('E:\WBB\luansheng\Dataset\Train2',guy)
...
model.save('wbb08resnet50_contr111.5.h5')
