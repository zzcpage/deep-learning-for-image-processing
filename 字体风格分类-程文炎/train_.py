...
input_shape = (64, 64, 3)
img= os.listdir('F:\Siamese_Keras\Dataset\original\Train')
...
images = []
img_labels = []
for guy in os.listdir('F:\Siamese_Keras\Dataset\original\Train'):
    person_dir = os.path.join('F:\Siamese_Keras\Dataset\original\Train',guy)
...
# print(x.size)
x_train,x_test,y_train,y_test = train_test_split(x,y,test_size = 0.12,random_state=30)
...
model.save('original_contr110.5.h5')
